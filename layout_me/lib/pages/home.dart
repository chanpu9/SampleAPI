...
class _HomePageState extends State<HomePage> {
  ...
  Future getData() async {
    // https://raw.githubusercontent.com/chanpu9/SampleAPI/main/data.json
    var url = Uri.https('raw.githubusercontent.com', '/chanpu9/SampleAPI/main/data.json');
    var response = await http.get(url);                       // รอ request ทำให้เสร็จ ถึงจะได้ response
